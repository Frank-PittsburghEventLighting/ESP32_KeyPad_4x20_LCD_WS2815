...
//  Find a Better Way to Control SPEED, No-Delay Commands
//   Test Frames per seconds  max 400
//  Code Commented, Good.
//	Code optimized for speed and readability.
//	*****************		Next:           *****************	 
...
int convKeyP = 11; int SpeedRate = 500;
...
#define PATTERN_LEN7B 7
  CRGB pattern7B[PATTERN_LEN7B ] = { CRGB::Red, CRGB::Red, CRGB::Gold, CRGB::Gold, CRGB::Green, CRGB::Green, CRGB::Black };   //  Key_55
...
void speedAndBrightnessControl() {
  ...
  Speed = map(SpeedRate, 0, 500, 100, 0);
 // delay(10);
